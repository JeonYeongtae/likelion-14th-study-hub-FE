  ...
  return (
    ...
    >
      <defs>
        ...
        {/* ── Displacement-map liquid glass (user-provided example) ──────────
         *  backdrop-filter: url(#liquid) → displaces blurred backdrop pixels
         *  using a pre-baked WebP normal map, producing organic refraction.
         *  primitiveUnits="objectBoundingBox" keeps the map tiled to the element.
         * ─────────────────────────────────────────────────────────────────── */}
