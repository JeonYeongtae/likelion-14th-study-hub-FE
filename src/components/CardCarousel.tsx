...
export const DEFAULT_CAROUSEL_CARDS: CarouselCard[] = [
  {
    ...
    tag: '스터디룸 예약',
    title: '원하는 공간을\n지금 바로.',
    description: '빈 자리를 즉시 확인하고 원하는 날짜·시간을 탭 몇 번으로 예약하세요. 색깔로 빈 시간과 예약된 시간을 한눈에 구분할 수 있습니다.',
  ...
  },
  {
    ...
    tag: '스터디 그룹',
    title: '같이 달리면\n더 빠릅니다.',
    description: '목표가 같은 사람들과 팀을 만드세요. 그룹 만들기부터 멤버 수락, 전용 채팅 시작까지 모든 과정이 하나로 이어집니다.',
  ...
  },
  {
    ...
    tag: '커뮤니티',
    title: '질문이\n답이 됩니다.',
    description: '모르는 것을 물어보고, 아는 것을 나누세요. 이미지·텍스트를 자유롭게 배치한 게시글과 댓글·대댓글로 깊은 토론을 이어가세요.',
  ...
  },
  {
    ...
    tag: '실시간 채팅',
    title: '그룹만의\n전용 공간.',
    description: '그룹이 확정되는 순간 채팅방이 자동으로 열립니다. 실시간 메시지, 공지사항, 멤버 목록까지 한 화면에서 확인하세요.',
  ...
  },
  {
    ...
    tag: '마이페이지',
    title: '나의 모든\n활동을 한눈에.',
    description: '내가 쓴 게시글, 댓글, 누른 좋아요, 예약 내역, 스터디 참여까지. 모든 활동을 탭 하나로 확인하고 관리할 수 있습니다.',
